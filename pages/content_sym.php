        ...
        <div class="row">
            ...
            <div class="col-md-3">                				
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(product_brand) FROM product WHERE product_status = '1' AND product_type = 'Symbian' ORDER BY product_id DESC";
				...
				<div class="list-group">
                    ...
                    $query = "
                    SELECT DISTINCT(product_ram) FROM product WHERE product_status = '1' AND product_type = 'Symbian' ORDER BY product_ram DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
				...
				<div class="list-group">
					...
					<?php
                    $query = "
                    SELECT DISTINCT(product_storage) FROM product WHERE product_status = '1' AND product_type = 'Symbian' ORDER BY product_storage DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
